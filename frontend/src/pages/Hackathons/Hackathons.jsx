...
function Hackathons() {
  ...
  const [hackathons] = useState([
...

     {
      ...
      description: "<p>COMSYS Hackathon-6, 2025 is a premier global hackathon hosted under The 4th International Conference on Data Electronics and Computing (ICDEC-2025) by COMSYS Educational Trust, in collaboration with Jadavpur University, Kolkata. Focusing on combating the rise of audio-based deepfake technologies, this hackathon inspires young innovators to build powerful AI/ML solutions capable of differentiating real voices from synthetic ones in challenging real-world environments.</p><h3>About the Conference (ICDEC-2025)</h3><p>The 4th International Conference on Data Electronics and Computing (ICDEC-2025) will be held from <strong>1st to 3rd December 2025</strong> at Baderia Global Institute of Engineering and Management, Jabalpur. The conference aims to bring together researchers, academicians, and industry professionals in the fields of Electronics, Computing, Image Processing, and Artificial Intelligence to exchange innovative ideas and foster collaborations.</p><h3>Hackathon Theme</h3><p><strong>Hack the Fake, Save the Real</strong> – A Deepfake Audio Classification Challenge in the Wild. This challenge emphasizes real-world applicability where audio clips may be noisy, compressed, manipulated, or adversarially engineered to bypass detection systems.</p><h3>Problem Statement</h3><p>With the rise of generative AI, audio deepfakes have emerged as a serious threat to security, privacy, and authenticity. Participants must build machine learning models that can distinguish between real and synthetic voices under diverse and unpredictable conditions.</p><h3>Hackathon Tasks</h3><ul><li><strong>Task A:</strong> Spot the Real vs Fake Voices (Binary Classification)</li><li><strong>Task B:</strong> TBA</li><li><strong>Task C:</strong> TBA</li></ul><h3>Why Participate?</h3><ul><li><strong>Real-World Challenge:</strong> Work on emerging security threats affecting society globally.</li><li><strong>Cutting-Edge AI/ML:</strong> Apply deep learning, audio processing, and adversarial defense techniques.</li><li><strong>Research & Collaboration:</strong> Engage with academia and industry experts.</li><li><strong>Impactful Innovation:</strong> Contribute to building a safer and more trustworthy digital world.</li></ul><h3>Eligibility Criteria</h3><ul><li>Open to <strong>Undergraduate, Postgraduate, and PhD students</strong> across disciplines.</li><li>Inter-college teams are allowed.</li><li>Team Size: <strong>1–4 members</strong>.</li><li>Each team must designate <strong>one team leader</strong> responsible for submissions.</li></ul><h3>Registration Details</h3><ul><li><strong>Registration Fee (India):</strong> INR 200 per team</li><li><strong>Registration Fee (International):</strong> USD 20 per team</li><li><strong>Payment Purpose:</strong> COMSYS-6 2025 Hackathon</li></ul><h3>Payment Instructions for International Participants</h3><ul><li><strong>Account Name:</strong> COMSYS Educational Trust</li><li><strong>Bank Name:</strong> State Bank of India</li><li><strong>Branch:</strong> Jadavpur University</li><li><strong>Account Number:</strong> 41078443652</li><li><strong>SWIFT Code:</strong> SBININBB368</li><li><strong>Bank Address:</strong> Jadavpur University Branch, Kolkata – 700032, West Bengal, India</li></ul><h3>Rules & Regulations</h3><ul><li><strong>Strict Deadline:</strong> No registrations accepted after closing date.</li><li><strong>Team Composition Locked:</strong> No changes allowed after registration.</li><li><strong>Mandatory Registration:</strong> Every team member must be registered.</li><li><strong>Single Team Membership:</strong> Participants may join only one team.</li><li><strong>Submission Requirement:</strong> Deliverables must include code and documentation.</li><li><strong>Ethical Compliance:</strong> Misuse of deepfake technology will result in disqualification.</li><li><strong>Organizer’s Decision:</strong> Final and binding.</li></ul><h3>Important Dates & Deadlines</h3><ul><li><strong>Registration Deadline:</strong> 19 October 2025, 11:11 PM IST</li><li><strong>Dataset Release:</strong> 20 October 2025</li><li><strong>Hackathon Dates:</strong> TBA</li></ul><h3>Contact</h3><p>For any queries, email: <strong>comsys6hackathon@gmail.com</strong></p><h3>Event Highlights</h3><ul><li><strong>Multiphase Competition:</strong> Challenges testing model robustness against adversarial attacks.</li><li><strong>Industry-Academia Collaboration:</strong> Opportunity to network with leading researchers.</li><li><strong>Focus on Real-World Application:</strong> Models must perform under noisy and manipulated audio conditions.</li></ul><h3>Join The Movement</h3><p>Be part of a groundbreaking initiative to protect digital communication by developing trustworthy AI systems to detect synthetic voices.<strong>Protect the truth in the age of AI.</strong></p>",
      startDate: "13-12-2025",
      endDate: "14-12-2025",
      venue: "The LNM Institute of Information Technology, Jaipur, Rajasthan, India",
      prize: "8,00,000",
      level: "Intermediate",
      category: "open",
      registrationStatus: "open",
      registrationDeadline: "08-12-2025",
